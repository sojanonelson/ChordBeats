const whiteKeys = [
  ...
  { keyName: "D4", audio: require("../../audio/piano/D4.mp3"), keyValue: "75" },
  { keyName: "E4", audio: require("../../audio/piano/E4.mp3"), keyValue: "76" },
  { keyName: "F4", audio: require("../../audio/piano/F4.mp3"), keyValue: "77" },
  { keyName: "G4", audio: require("../../audio/piano/G4.mp3"), keyValue: "78" },
  { keyName: "A4", audio: require("../../audio/piano/A4.mp3"), keyValue: "186" },
  { keyName: "B4", audio: require("../../audio/piano/B4.mp3"), keyValue: "222" },
  { keyName: "C4", audio: require("../../audio/piano/C5.mp3"), keyValue: "220" },
];
...
const blackKeys = [
  ...
  { keyName: "", audio: require("../../audio/piano/C3.mp3"), keyValue: "" },
  { keyName: "Cb4", audio: require("../../audio/piano/C3.mp3"), keyValue: "87" },
  { keyName: "Db4", audio: require("../../audio/piano/C3.mp3"), keyValue: "69" },
  { keyName: "", audio: require("../../audio/piano/C3.mp3"), keyValue: "" },
  { keyName: "Fb4", audio: require("../../audio/piano/C3.mp3"), keyValue: "89" },
  { keyName: "Gb4", audio: require("../../audio/piano/C3.mp3"), keyValue: "85" },
  { keyName: "Ab4", audio: require("../../audio/piano/C3.mp3"), keyValue: "79" },
  { keyName: "", audio: require("../../audio/piano/C3.mp3"), keyValue: "" },
];
